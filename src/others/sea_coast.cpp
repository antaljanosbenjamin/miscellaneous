...
const vector<CoordOffset> SeaCoastCounter::ms_vectorNeighbourOffsets{CoordOffset(1, 0), CoordOffset(0, -1),
                                                                     CoordOffset(-1, 0), CoordOffset(0, 1)};

constexpr CoordOffset::CoordOffset(int iRowOffset, int iColOffset)
  : iRowOffset(iRowOffset)
  , iColOffset(iColOffset) {
}
...
SeaCoastCounter::SeaCoastCounter()
  : m_sRows(0)
  , m_sCols(0)
  , m_sRowsInside(0)
  , m_sColsInside(0)
  , m_vectorMap()
  , m_queueCoordsToBecameSea()
  , uiSeaCoastLength(0) {
}
